...
class EventAccessorInjectorScript(InjectorScriptBase):
    ...
    def create_script_file(self):
        ...
        super().priv_create_script_file("#!/bin/bash\n"
            ...
            "    if [ -e \"$DIR_SAVE_ENTRIES/$entry_file_name\" ]; then\n"
            "        [ -z \"$DIR_SAVE_ENTRIES/$entry_file_name\" ] && return\n"
            ...
            "\n"
            "    if [ \"$event\" = \"$EVENT\" ]; then\n"
            "       device=`cat $DIR_SAVE_ENTRIES/$entry_file_name | tail -1`\n"
            ...
            "       echo -ne waiting for the event, trying at most $interactions times to get a new EventLogId ...\r \n"
            "       sleep 4\n"
